(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@angular-material-extensions/google-maps-autocomplete', ['exports', '@angular/core', '@angular/forms', '@agm/core', '@angular/animations', 'rxjs/operators', 'rxjs/internal/Subject', '@angular/common', '@angular/flex-layout', '@angular/material/icon', '@angular/material/input'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['angular-material-extensions'] = global['angular-material-extensions'] || {}, global['angular-material-extensions']['google-maps-autocomplete'] = {}), global.ng.core, global.ng.forms, global.core$1, global.ng.animations, global.rxjs.operators, global.rxjs['internal/Subject'], global.ng.common, global.ng.flexLayout, global.ng.material.icon, global.ng.material.input));
}(this, (function (exports, core, forms, core$1, animations, operators, Subject, common, flexLayout, icon, input) { 'use strict';
    ...
    var MatSearchGoogleMapsAutocompleteComponent = /** @class */ (function () {
        function MatSearchGoogleMapsAutocompleteComponent(formBuilder) {
            ...
            this._unsubscribeAll = new Subject.Subject();
        }
        ...
        MatSearchGoogleMapsAutocompleteComponent.prototype.enableCustomInput = function () {
            ...
            this.addressFormGroup
                ...
                console.log('custom input - new german address', _this.value);
